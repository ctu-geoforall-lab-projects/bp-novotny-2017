...
%%% ML: zkuste zaver jeste rozepsat...
...
%%% ML: zkratka WFS neni uvedena v seznamu
%%% RN: spolu s dalsimi pridana
...
%%% ML: Zde hlavne chybi informace o zdrojovych kodech, ktere jsou
%%% dostupne z Git repositare na GitHubu...
